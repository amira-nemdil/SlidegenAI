...
class SlideDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        labels = labels.masked_fill(labels == tokenizer.pad_token_id, -100).long()
        return {
...
def train_model(epochs=1):
    ...
    torch.save(model.state_dict(), "flan_t5_slidegen_final.pth")
    print("✅ Final model saved to flan_t5_slidegen_final.pth")
